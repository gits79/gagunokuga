...
1. 우리 생각보다 잘 해내고 있는 것 같다.
2. 앞으로 할 일과 그에 대한 정리가 필요하다.
...
1. 발표
2. 프론트엔드 코드에 백엔드 코드 통합 시작 

- 깨달은 점 : 

1. 발표에서 장단점에 대해 파악하고 더 보완할 필요를 느꼈습니다. 

- 내일 할 일 : 

1. 발표 평가 확인하기
2. 프론트엔드에 백엔드 코드 연동시키기 
...
1. 자기반성
2. 프론트엔드 코드와 백엔드 코드의 연동  

- 깨달은 점 : 

1. 프로젝트를 할꺼면 최신 기술로 수행할 것. 
